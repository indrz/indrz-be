...
function getMapSize(){
    ...
    return {"width_px":mapWidthPixels, "height_px": mapHeightPixels,
...
function map2pdf() {
    ...
    map.once('postcompose', function (event) {
        ...
        if (canvas.toBlob) {
            ...
            var x = calculateAspectRatioFit(canvasMapWidth, canvasMapHeight, maxWidth, maxHeight);
            ...
            // console.log("great test: h"+ x.height);
               ...
               reader.onloadend = function() {
                   ...
                   if(ratio > 1){
                       ...
                       doc.addImage(base64data, 'PNG', pdfLeftMargin, 40, x.width, x.height);
