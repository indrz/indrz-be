...
var wmsfloorLayerGroup = new ol.layer.Group({layers: [wmsE00, wmsE01, wmsE02, wmsE03], name: gettext("wms floor maps")});
var poiLayerGroup = new ol.layer.Group({layers: [], id:99999, name: gettext("poi group")});
var campusLocationsGroup = new ol.layer.Group({layers: [], id:900, name: gettext("campus locations")});

var routeLayerGroup = new ol.layer.Group({layers:[], name: gettext("route group")});
